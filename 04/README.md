...
Установку и настройку zfs вынес в отдельный скрипт (/homework/04/setup_zfs.sh) и внес его в Vagrantfile.
...
```
Таким образом видно, что максимальную степень сжатия имеет алгоритм gzip-9.
...
```
Командами zfs определил настройки:
